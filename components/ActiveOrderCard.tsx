...
export const ActiveOrderCard: React.FC<ActiveOrderCardProps> = ({ order, onAction, defaultExpanded = false }) => {
  ...
  return (
    <div className="bg-[#1a222e] rounded-3xl border border-white/5 shadow-2xl overflow-hidden transition-all duration-300">
        ...
        <div className="flex items-center gap-3">
          {!isExpanded && (
            <button 
              ...
              className="w-10 h-10 bg-yellow-400 text-gray-900 rounded-xl flex items-center justify-center shadow-lg shadow-yellow-400/20 active:scale-90 transition-transform"
            >
